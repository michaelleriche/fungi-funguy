      ...
      return (
        <footer>
            <div className="wrapper">
                <h3 className="hiScoreTitleTwo wrapper" tabIndex="0">Disclaimer!</h3>
                <p>This game is made out of love and respect for the mushroom, fungi, and the entire natural world. Whatever you do, don't eat random mushrooms you find in the woods! You could get very sick and possibly even die.</p>
