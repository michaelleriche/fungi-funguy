...
const FinalScore = (props) => {
    return (
        <div className="finalScoreBanner wrapper">
            <h3 className="finalHeader"><span className="hiScoreTitleTwo">Congrats </span><span className="hiScoreTitleThree">Congrats</span> <span className="hiScoreTitleTwo">Congrats </span></h3>
